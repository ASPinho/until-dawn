...
import deltaqueues.dronnie.backgrounds.Hills;
...
public class HillScreen implements Screen {
    ...
    private Hills parallaxBackground;

    private Skin skin;

    public HillScreen(Game game, Skin skin, Screen overWorld) {
        ...
        for (int i = 1; i <= 6; i++) {
            textures.add(new Texture(Gdx.files.internal("parallax/hills/Hill_0" + i + ".png")));
        ...
        parallaxBackground = new Hills(textures);
